...
public class AuthConfiguration {
    ...
    private static final String UTENTE_ROLE = "ROLE_UTENTE";
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/utente/**").hasAnyAuthority(UTENTE_ROLE)
    ...
    private void handleLoginSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        if (roles.contains("ROLE_UTENTE")) {
            response.sendRedirect("/utente/index");
        }
        else {
